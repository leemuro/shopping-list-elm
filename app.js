...
var _user$project$Categories$defaultCategories = _elm_lang$core$Native_List.fromArray(
	[
		...
		exclusions: _elm_lang$core$Native_List.fromArray(
			['can', 'dried', 'dry', 'powder', 'tsp', 'tbsp', 'teaspoon', 'tablespoon', 'frozen', 'juice', 'jam', 'jelly', 'sauce', 'with green chilis'])
	},
		{
		name: 'Meat',
		matchers: _elm_lang$core$Native_List.fromArray(
		...
		matchers: _elm_lang$core$Native_List.fromArray(
			['bread', 'tortilla', 'wrap', 'pita', 'muffin', 'bun', 'roll']),
		exclusions: _elm_lang$core$Native_List.fromArray(
		...
		name: 'Spices/Herbs',
		matchers: _elm_lang$core$Native_List.fromArray(
			['allspice', 'all spice', 'spice', 'anise', 'basil', 'bay leaf', 'caraway', 'cardamom', 'cayenne', 'pepper', 'celery seed', 'chicory', 'chili powder', 'dill', 'garlic', 'chives', 'cilantro', 'cinnamon', 'clove', 'coriander', 'cumin', 'curry', 'dill', 'fennel', 'fenugreek', 'ginger', 'lavender', 'marjoram', 'mint', 'mustard', 'nutmeg', 'oregano', 'paprika', 'parsley', 'rosemary', 'saffron', 'sage', 'safflower', 'tarragon', 'thyme', 'turmeric', 'vanilla', 'salt', 'powder', 'dried onion', 'dried minced onion']),
		exclusions: _elm_lang$core$Native_List.fromArray(
			['fresh'])
	},
		{
		...
		name: 'Beverages',
		matchers: _elm_lang$core$Native_List.fromArray(
			['pop', 'soda', 'water', 'juice', 'tea', 'coke', 'sprite', 'dr', 'dr pepper']),
		exclusions: _elm_lang$core$Native_List.fromArray(
			[])
	},
		{
